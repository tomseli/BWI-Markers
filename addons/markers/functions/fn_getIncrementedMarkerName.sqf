...
// Fetch the ID.
private _locationID = bwi_markers_locationIDs select _closestLocationIndex;

// Fetch and increment the location IDs incrementer.
private _locationNum = bwi_markers_locationIncrements select _closestLocationIndex;
bwi_markers_locationIncrements set [_closestLocationIndex, _locationNum + 1];
